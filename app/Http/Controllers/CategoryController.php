...
class CategoryController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            Alert::error(
                ...
                trans('categories.alert.update.message.error', ['eror' => $th->getMessage()])
            );
    ...
    public function update(Request $request, Category $category)
    {
        ...
        try {
            ...
            Alert::error(
                trans('categories.alert.create.title'),
                trans('categories.alert.create.message.error', ['eror' => $th->getMessage()])
            );
    ...
    public function destroy(Category $category)
    {
        try {
            ...
            Alert::error(
                trans('categories.alert.delete.title'),
                trans('categories.alert.delete.message.error', ['eror' => $th->getMessage()])
            );
        }
        //return ke halaman sebelumnya
