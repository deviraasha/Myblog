        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <div class="form-group">
                ...
                <input name="email" value="{{ old('email') }}"
                    class="form-control py-4 form-control @error('email') is-invalid @enderror" id="input_login_email"
                    type="email" placeholder="Enter email address" autocomplete="email" />
            ...
            <div class="form-group">
                ...
                <input name="password" class="form-control py-4 form-control @error('password') is-invalid @enderror"
