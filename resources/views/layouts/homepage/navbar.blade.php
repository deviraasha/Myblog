    ...
    <header id="header" class="fixed-top navbar-expand-lg">
        <div class="container d-flex align-items-center">
            <h1 class="logo me-auto"><a href="{{ route('homepage.home') }}"><img
                        src="{{ asset('assets/img/2.png') }}" alt="" class="img-fluid"></a></h1>
                    ...
                    @auth
                        <li class="dropdown"><a href="#"><span>{{ auth()->user()->name }}</span> <i
                            ...
                            <ul>
                                ...
                                <li><a href="{{ route('logout') }}">{{ trans('homepage.menu.logout') }}</a></li>
