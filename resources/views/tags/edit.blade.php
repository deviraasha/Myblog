                    ...
                    <form action="{{ route('tags.update', ['tag' => $tag]) }}" method="POST">
                        ...
                        <div class="form-group">
                            <label for="input_tag_title" class="font-weight-bold">
                                {{ trans('tag.form_control.input.title.label') }}
                            </label>
                            <input id="input_tag_title" value="{{ old('title', $tag->title) }}" name="title" type="text"
                                class="form-control @error('title') is-invalid @enderror"
                                placeholder="{{ trans('tag.form_control.input.title.placeholder') }}" />
                            @error('title')
                        ...
                        <div class="form-group">
                            <label for="input_tag_slug" class="font-weight-bold">
                                {{ trans('tag.form_control.input.slug.label') }}
                            </label>
                            <input id="input_tag_slug" value="{{ old('slug', $tag->title) }}" name="slug" type="text"
                                class="form-control @error('slug') is-invalid @enderror"
                                placeholder="{{ trans('tag.form_control.input.slug.placeholder') }}" readonly />
                            @error('slug')
                                <span class="invalid-feedback">
                                    <strong>{{ $message }}</strong>
                                </span>
